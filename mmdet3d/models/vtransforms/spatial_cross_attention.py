...
from mmdet3d.models.utils.multi_scale_deformable_atten_function import MultiScaleDeformableAttnFunction_fp32, \
...
class SpatialCrossAttention(BaseModule):
    ...
    def forward(self,
                ...
                spatial_shapes=None,
                reference_points_cam=None, #  shape: (D, B, num_query, 2)
                bev_mask=None, # shape: (num_cam, B, num_query, D)
        ...
        indexes = []
        # 只处理有效的BEV query，即在相机视锥内的bev query
...
class MSDeformableAttention3D(BaseModule):
    ...
    def __init__(self,
        ...
        self.sampling_offsets = nn.Linear(
            embed_dims, num_heads * num_levels * num_points * 2) # 输出off_set
        self.attention_weights = nn.Linear(embed_dims,
                                           num_heads * num_levels * num_points) # 输出attention weight
